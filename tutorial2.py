...
if __name__ == '__main__':
    ...
    # run 15 detect v8n
    # run 16 detect v8s
    model.train(data = 'UA-DETRAC.yaml', epochs = 500, lr0 = 0.001, batch=32, device = 1) 
    # model.info()
    # model.export()
...
# pruning 
# python benchmarks/prunability/yolov8_pruning.py --model asset/trained_model/UA-DETRAC/v8s_DETRACT.pt --data UA-DETRAC.yaml --iterative-steps 2 --epochs 300 --target-prune-rate 0.1 --batch 16 --device 0
# python benchmarks/prunability/yolov8_pruning.py --model asset/trained_model/UA-DETRAC/v8s_DETRACT.pt --data UA-DETRAC.yaml --iterative-steps 2 --epochs 300 --target-prune-rate 0.2 --batch 16 --device 1
